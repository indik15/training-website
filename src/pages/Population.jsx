    ...
    <main className="container px-4 py-4">
      <div className="row">
        ...
        <article className="col-md-9">
          <h2 className="h2 text-success mb-4">Ареал поширення лам</h2>
          ...
          <section id="subcontinents" className="mt-4">
            ...
            <div className="collapse" id="subcontinentsList">
              <ul className="list-group mb-3">
                <li class="list-group-item">Анди</li>
              </ul>
            </div>
          </section>
          ...
          <section id="biomes" className="mt-4">
            ...
            <div className="collapse" id="biomesList">
              <ul className="list-group">
                <li class="list-group-item">Сільськогоспподарські угіддя</li>
                <li class="list-group-item">Антропогенний біом</li>
                <li class="list-group-item">Гори</li>
              </ul>
            </div>
          </section>
        </article>
